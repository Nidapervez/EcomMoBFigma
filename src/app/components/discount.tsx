...
const Discount = () => {
  return (
    <div><div className="h-[656px] px-40 py-20 bg-white flex-col justify-start items-start gap-8 inline-flex">
    <div className="text-center text-black text-2xl font-medium font-['Inter'] leading-loose">
      Discounts up to -50%
    </div>
    <div className="self-stretch justify-start items-start gap-4 inline-flex">
      <div className="grow shrink basis-0 px-4 py-6 bg-[#f6f6f6] rounded-[9px] flex-col justify-start items-center gap-4 inline-flex">
